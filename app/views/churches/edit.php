                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Select from registered pastors. Only users with the Pastor role appear here. To assign a head pastor, please use the church profile page.</div>
                            </div>
                        </div>
                    </div>
