        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?= AssetHelper::url('properties/' . $property['id']) ?>"><?= htmlspecialchars($property['name'] ?? '') ?></a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= AssetHelper::url('properties/' . $property['id']) ?>" method="POST" enctype="multipart/form-data" id="property-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category_id" name="category_id" required>
                                    ...
                                    <?php foreach ($categories as $cat): ?>
                                        <option value="<?= $cat['id'] ?>" 
                                                <?= ($post['category_id'] ?? $property['category_id'] ?? '') == $cat['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status" name="status" required>
                                    <?php foreach ($statusOptions as $key => $label): ?>
                                        <option value="<?= $key ?>" 
                                                <?= ($post['status'] ?? $property['status'] ?? 'available') === $key ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" required
                               value="<?= htmlspecialchars($post['name'] ?? $property['name'] ?? '') ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"
                                  placeholder="Describe the property..."><?= htmlspecialchars($post['description'] ?? $property['description'] ?? '') ?></textarea>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="location" name="location"
                                       value="<?= htmlspecialchars($post['location'] ?? $property['location'] ?? '') ?>"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="serial_number" name="serial_number"
                                       value="<?= htmlspecialchars($post['serial_number'] ?? $property['serial_number'] ?? '') ?>"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="purchase_date" name="purchase_date"
                                       value="<?= htmlspecialchars($post['purchase_date'] ?? ($property['purchase_date'] ?? '')) ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="purchase_cost" name="purchase_cost"
                                           step="0.01" min="0"
                                           value="<?= htmlspecialchars($post['purchase_cost'] ?? $property['purchase_cost'] ?? '') ?>"
                                           placeholder="0.00">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Leave empty to keep current image. JPG, PNG, GIF or WebP. Max 5 MB.</div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="notes" name="notes" rows="3"
                                  placeholder="Additional notes..."><?= htmlspecialchars($post['notes'] ?? $property['notes'] ?? '') ?></textarea>
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i data-feather="save" class="me-1"></i> Update Property
                        </button>
                        <a href="<?= AssetHelper::url('properties/' . $property['id']) ?>" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
