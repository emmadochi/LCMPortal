...
<div class="container-fluid p-0 fin-dashboard">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 small">
                        ...
                        <li class="breadcrumb-item active text-primary fw-semibold"><?= htmlspecialchars($churchName) ?></li>
                    </ol>
                </nav>
                <h3 class="mb-0 fw-bold text-dark d-flex align-items-center gap-2">
                    <i class="bx bx-church text-primary"></i> <?= htmlspecialchars($churchName) ?> — Financial Management
                </h3>
            </div>
            <div class="d-flex gap-2 flex-wrap">
                <a href="<?= AssetHelper::url("churches/{$churchId}/budgets") ?>" class="fin-action-btn fin-btn-outline">
                    <i class="bx bx-pie-chart-alt-2 text-primary"></i> Budgets
                </a>
                <a href="<?= AssetHelper::url("churches/{$churchId}/pledges") ?>" class="fin-action-btn fin-btn-outline">
                    <i class="bx bx-gift text-success"></i> Pledges
                </a>
                <a href="<?= AssetHelper::url("churches/{$churchId}/finance/cashflow") ?>" class="fin-action-btn fin-btn-outline">
                    <i class="bx bx-line-chart text-info"></i> Cashflow
                </a>
                <a href="<?= AssetHelper::url("churches/{$churchId}/finance/audit-trail") ?>" class="fin-action-btn fin-btn-outline">
                    <i class="bx bx-shield-quarter text-secondary"></i> Audit Trail
                </a>
                <a href="<?= AssetHelper::url("churches/{$churchId}/finance/create") ?>" class="fin-action-btn fin-btn-primary">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="fin-metric-card">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="fin-label">Branch Total Income</div>
                ...
                <div class="fin-subtext">
                    ...
                    <span><?= $txCount ?> Transactions Logged</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="fin-metric-card">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="fin-label">Branch Total Expenses</div>
                ...
                <div class="fin-subtext">
                    ...
                    <span>Local branch disbursements</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="fin-metric-card">
                ...
                <div class="fin-subtext">
                    ...
                    <span>Net branch liquid balance</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            <div class="fin-panel h-100 mb-0">
                <div class="fin-panel-header">
                    ...
                    <a href="<?= AssetHelper::url("churches/{$churchId}/finance/cashflow") ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                        Full Cashflow &rarr;
                    </a>
                </div>
        ...
        <!-- Unit/Department Breakdown -->
        <div class="col-lg-4">
            <div class="fin-panel h-100 mb-0">
                <div class="fin-panel-header">
                    <h5 class="fin-panel-title">
                        <i class="bx bx-pie-chart-alt text-success fs-5"></i> Department Breakdown
                    </h5>
                </div>
                <div class="fin-panel-body p-0">
                    <?php if (empty($unit_breakdown)): ?>
                        <div class="text-center py-5 text-muted">
                            <i class="bx bx-buildings fs-1 opacity-25 mb-2"></i>
                            <p class="mb-0 small">No unit revenue recorded yet.</p>
                        </div>
                    <?php else: ?>
                        <div class="table-responsive" style="max-height: 290px;">
                            <table class="fin-table mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($unit_breakdown as $u): 
                                        $uInc = (float)($u['total_income'] ?? 0);
                                        $uExp = (float)($u['total_expense'] ?? 0);
                                        $uNet = $uInc - $uExp;
                                    ?>
                                    <tr>
    ...
    <div class="fin-panel">
        <div class="fin-panel-header">
            <h5 class="fin-panel-title">
                <i class="bx bx-receipt text-primary fs-5"></i> Recent Transactions
            </h5>
            <a href="<?= AssetHelper::url("churches/{$churchId}/finance/all") ?>" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                Full Ledger &rarr;
            </a>
        </div>
        <div class="fin-panel-body p-0">
                ...
                <div class="table-responsive">
                    <table class="fin-table mb-0">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td class="text-muted small"><?= date('M d, Y', strtotime($r['transaction_date'] ?? $r['created_at'])) ?></td>
                                <td><span class="fin-badge fin-badge-info"><?= htmlspecialchars($r['category'] ?: 'General') ?></span></td>
                                <td>
                                ...
                                <td>
                                    <span class="badge bg-light text-secondary border">
                                        <?= htmlspecialchars(ucfirst($r['payment_method'] ?? 'Transfer')) ?>
                                    </span>
                                </td>
                                ...
                                <td class="text-end text-muted small"><?= htmlspecialchars(trim(($r['first_name'] ?? '') . ' ' . ($r['last_name'] ?? '')) ?: 'Pastor') ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var options = {
        ...
        xaxis: { categories: labels, labels: { style: { colors: '#64748b', fontSize: '12px' } } },
        yaxis: {
            labels: {
